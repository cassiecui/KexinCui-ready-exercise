...
plot(p5)
figure_file <- here("results", "figures", "height-by-haircolor.png")
ggsave(filename = figure_file, plot=p5)
```

```{r}
p6 <- mydata %>% ggplot(aes(x=Weight, y=DailySteps)) + geom_point() + geom_smooth(method="lm")
plot(p6)
figure_file <- here("results", "figures", "daily-steps-vs-weight.png")
